...
SHOW WARNINGS;
CREATE INDEX `fk_Published_Citation1_idx` ON `ChemDB`.`Published` (`Citation_citation_id` ASC, `Citation_pmid` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_Published_Assay1_idx` ON `ChemDB`.`Published` (`Assay_aeid` ASC);
...
SHOW WARNINGS;
CREATE INDEX `fk_Tested_Target1_idx` ON `ChemDB`.`Tested` (`Target_target_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_Tested_Assay1_idx` ON `ChemDB`.`Tested` (`Assay_aeid` ASC);
