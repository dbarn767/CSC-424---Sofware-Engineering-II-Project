...
SHOW WARNINGS;
CREATE INDEX `fk_Published_Citation_idx` ON `ChemDB`.`Published` (`citation_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_Published_Citation1_idx` ON `ChemDB`.`Published` (`pmid` ASC);
