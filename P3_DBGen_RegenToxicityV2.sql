...
CREATE TABLE IF NOT EXISTS `ChemDB`.`Chemicals` (
  ...
  `Structure_InChI` VARCHAR(112) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ChemDB`.`Toxicity` (
  ...
  PRIMARY KEY (`aeid`, `Substance_CASRN`),
  INDEX `fk_Toxicity_Assay1_idx` (`aeid` ASC),
  INDEX `fk_Toxicity_Chemicals1_idx` (`Substance_CASRN` ASC),
